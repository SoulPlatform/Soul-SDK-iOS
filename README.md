...
## Установка
Для установки SoulSDK необходимо в `Podfile` добавить следующее:
...
* `filterable` - параметры, которые могут влиять на фильтрацию результатов при поиске партнёров
* `private` - данные, доступные для изменения и просмотра только текущим пользователем
